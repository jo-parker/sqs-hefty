...
func TestReferenceMessageSerialization(t *testing.T) {
	expected := `{"identifier":"%s","s3_region":"testS3RegionVal","s3_bucket":"testS3BucketVal","s3_key":"testS3KeyVal","md5_digest_msg_body":"testMd5BodyVal","md5_digest_msg_attr":"testMd5AttrVal"}`
